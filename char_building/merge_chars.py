...
conn = wrds.Connection(wrds_username='hd2570')
...
with open('firm_beta_estimates.feather', 'rb') as f:
...
with open('capm_residual_variance.feather', 'rb') as f:
...
with open('dollar_volume_std.feather', 'rb') as f:
    std_dolvol = feather.read_feather(f)
...
with open('turnover_std_dev.feather', 'rb') as f:
    std_turn = feather.read_feather(f)
