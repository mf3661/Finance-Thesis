...
OUTPUT_DIR = BASE_DIR / "4_1_9_figure7" / "output"
...
STRATEGIES = {
    ...
    "EW": [
        BASE_DIR / "4_1_2_ap_forest_ew" / "output" / "ensemble_monthly_returns.csv",
    ],
}
...
def plot_figure(cum_log_returns: pd.DataFrame) -> None:
    ...
    fig_png = OUTPUT_DIR / "figure7_vw_vs_ew.png"
    fig_pdf = OUTPUT_DIR / "figure7_vw_vs_ew.pdf"
...
def main() -> None:
    ...
    monthly_path = OUTPUT_DIR / "figure7_monthly_returns_merged.csv"
    cumlog_path = OUTPUT_DIR / "figure7_cumulative_log_returns.csv"
    summary_path = OUTPUT_DIR / "figure7_summary.csv"
