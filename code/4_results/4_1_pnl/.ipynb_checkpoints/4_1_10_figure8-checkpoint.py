...
OUTPUT_DIR = BASE_DIR / "4_1_10_figure8" / "output"
...
STRATEGIES = {
    ...
    "Impute": [
        BASE_DIR / "4_1_3_ap_forest_impute" / "output" / "ensemble_monthly_returns.csv",
    ],
}
...
def plot_figure(cum_log_returns: pd.DataFrame) -> None:
    ...
    fig_png = OUTPUT_DIR / "figure8_no_impute_vs_impute.png"
    fig_pdf = OUTPUT_DIR / "figure8_no_impute_vs_impute.pdf"
...
def main() -> None:
    ...
    monthly_path = OUTPUT_DIR / "figure8_monthly_returns_merged.csv"
    cumlog_path = OUTPUT_DIR / "figure8_cumulative_log_returns.csv"
    summary_path = OUTPUT_DIR / "figure8_summary.csv"
