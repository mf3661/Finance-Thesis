...
SPLIT_BASE = Path("../../../data/2_tree_construction/2_1_split/2_1_1_split/output")
FILTER_BASE = Path("../../../data/2_tree_construction/2_3_filter/2_3_1_filter/output")
PRUNE_BASE = Path("../../../data/3_ap_prune/3_1_prune_cv/3_1_1_prune_cv/output")

OUTPUT_BASE = Path("../../../data/4_results/4_4_turnover/4_4_1_turnover_ap_forestI/output")
