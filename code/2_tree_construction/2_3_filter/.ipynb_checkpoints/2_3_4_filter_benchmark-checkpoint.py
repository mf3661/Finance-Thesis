...
# paths
# =========================================================
COMBINE_OUTPUT_BASE_DIR = "../../../data/2_tree_construction/2_2_combine_portfolio/2_2_4_combine_benchmark/output"
FILTER_OUTPUT_BASE_DIR = "../../../data/2_tree_construction/2_3_filter/2_3_4_filter_benchmark/output"
...
def filter_one_repeat(input_dir: str, output_dir: str, repeat_tag: str, min_valid_frac: float):
    ...
    # metadata file may be empty in broken upstream runs; handle more gracefully
...
if __name__ == "__main__":
    ...
    # at least this fraction of months must be non-missing
