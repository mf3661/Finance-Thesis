...
OUTPUT_BASE_DIR = "../../../data/2_tree_construction/2_1_split/2_1_2_split_ew/output"
...
def equal_weighted_return(x: pd.DataFrame, ret_col: str, weight_col: str):
    """
    Equal-weighted node return.

    weight_col is kept in the function signature so the rest of the code
    ...
    return float(np.mean(r[good]))


def compute_node_ret(node_df: pd.DataFrame, ret_col: str, weight_col: str):
    return equal_weighted_return(node_df, ret_col, weight_col)
